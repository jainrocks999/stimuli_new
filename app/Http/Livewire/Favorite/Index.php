...
class Index extends Component
{
    ...
    public function mount()
    {
        ...
        $this->orderable         = (new Favorite())->orderable;
    }

    public function render()
    {
        $query = Favorite::with(['user','affirmation','categories'])->advancedFilter([
            's'               => $this->search ?: null,
        ...
        return view('livewire.favorite.index', compact('favorites', 'query'));
    }
